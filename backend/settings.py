...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-5x)p9(c$t4=74blrfmvxkn_9^1@6u*ye-roow4&3oh)6jyfm3y')
...
# Password validation not needed for Google OAuth-only authentication
...
# CSRF settings for frontend/backend on same domain
